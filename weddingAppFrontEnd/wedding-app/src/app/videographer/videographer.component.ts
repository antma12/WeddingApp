...
export class VideographerComponent {
    ...
    constructor(private videographerService : VideographerService, private router : Router) {
    ...
    removeVideographer = function(videographer) {
        this.videographerService.removeVideographer(videographer).subscribe(() => {this.getVideographers()});
    }
}